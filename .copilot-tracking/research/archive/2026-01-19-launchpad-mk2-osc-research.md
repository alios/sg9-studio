...
- [docs/STUDIO.md](../../../docs/STUDIO.md): Hardware setup, monitoring model
- [docs/ARDOUR-SETUP.md](../../../docs/ARDOUR-SETUP.md): Track configuration, VCAs, routing
- [docs/MIDI-CONTROLLERS.md](../../../docs/MIDI-CONTROLLERS.md): Existing MIDI integration guide
